    ...
    <div class="container py-xl-5 py-lg-3">
        ...
        <div class="row blog-content">
            ...
            <div class="col-lg-8 blog_section">
                <div class="card">
                    <img class="card-img-top" src="<?php bloginfo( 'stylesheet_directory' ) ?>/images/blog1.jpg" alt="">
                ...
                <div class="card my-4">
                    <img class="card-img-top" src="<?php bloginfo( 'stylesheet_directory' ) ?>/images/blog2.jpg" alt="">
                    <div class="card-body text-center">
                        <h6 class="blog-first text-dark">
                ...
                <div class="card my-4">
                    <img class="card-img-top" src="<?php bloginfo( 'stylesheet_directory' ) ?>/images/blog3.jpg" alt="">
                    <div class="card-body text-center">
                        <h6 class="blog-first text-dark">
